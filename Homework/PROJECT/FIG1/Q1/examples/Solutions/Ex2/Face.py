...
## --------------------
## face class with noseSize, har colour and hair length
...
# --------------------------------------------------
    ...
    def drawHairStrand(self, headAngle, headAngleIncrement):
        ...
        if self.hairLength == 'short':
            segs = 4
        elif self.hairLength == 'shoulder':
            segs = 10
        elif self.hairLength == 'long':
            segs = 16
